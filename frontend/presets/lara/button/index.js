export default {
    root: ({ props, context, parent }) => ({
        class: [
            ...
            // Amir Button
            {
                'text-white dark:text-blue-100': props.severity === 'amir' && !props.text && !props.outlined && !props.plain,
                'bg-blue-100 dark:bg-gray-900': props.severity === 'amir' && !props.text && !props.outlined && !props.plain,
                'border border-blue-500 dark:border-blue-400': props.severity === 'amir' && !props.text && !props.outlined && !props.plain
            },
            // Primary Button
            {
